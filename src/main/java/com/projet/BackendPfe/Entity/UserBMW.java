...
@Entity
@DiscriminatorValue(value="UserBMW")
public class UserBMW extends User {
	...
	public UserBMW(int cin, String nom, String prenom, String gender, String username, String email, String password,
