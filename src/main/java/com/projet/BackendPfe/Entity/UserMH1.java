...
@Entity
@DiscriminatorValue(value="UserMH1")
public class UserMH1 extends User {
	...
	public UserMH1(int cin, String nom, String prenom, String gender, String username, String email, String password,
