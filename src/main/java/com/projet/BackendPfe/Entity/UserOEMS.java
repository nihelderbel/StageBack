...
@Entity
@DiscriminatorValue(value="UserOEMS")
public class UserOEMS extends User {
	...
	public UserOEMS(int cin, String nom, String prenom, String gender, String username, String email, String password,
