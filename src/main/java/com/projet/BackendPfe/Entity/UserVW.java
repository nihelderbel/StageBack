...
@Entity
@DiscriminatorValue(value="UserVW")
public class UserVW extends User{
	...
	public UserVW(int cin, String nom, String prenom, String gender, String username, String email, String password,
