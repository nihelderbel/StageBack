...
@Entity
@DiscriminatorValue(value="UserMS")
public class UserMS extends User {
	...
	public UserMS(int cin, String nom, String prenom, String gender, String username, String email, String password,
