...
@Entity
@DiscriminatorValue(value="UserAudi")
public class UserAudi extends User{
	...
	public UserAudi(int cin, String nom, String prenom, String gender, String username, String email, String password,
