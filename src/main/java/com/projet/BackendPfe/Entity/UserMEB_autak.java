...
@Entity
@DiscriminatorValue(value="UserMEBAutak")
public class UserMEB_autak extends User {
	...
	public UserMEB_autak(int cin, String nom, String prenom, String gender, String username, String email, String password,
