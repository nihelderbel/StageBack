...
@Entity
@DiscriminatorValue(value="UserMH2")
public class UserMH2 extends User {
	...
	public UserMH2(int cin, String nom, String prenom, String gender, String username, String email, String password,
