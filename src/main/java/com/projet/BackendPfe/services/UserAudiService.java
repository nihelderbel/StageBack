...
@Service
public class UserAudiService implements IUserAudi {
	@Autowired UserAudiRepository  audi;
	private List<UserAudi> liste_audi=new ArrayList<UserAudi>();
	
	@Override
	public byte[] getImageUserAudi(long id) throws Exception {
		// TODO Auto-generated method stub
		String image =audi.findById(id).get().getImage() ; 
	...
	public String generateUniqueUsername(String nom, String prenom) {
        ...
        if (!(audi.existsByUsername(baseUsername))) {
            ...
            while (audi.existsByUsername(uniqueUsernameBuilder.toString())) {
