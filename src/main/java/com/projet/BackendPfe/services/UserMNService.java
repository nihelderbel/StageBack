...
@Service
public class UserMNService implements IUserMN {

@Autowired UserMNRepository  mn;
	
	private List<UserMN> liste_mn=new ArrayList<UserMN>();

	
	@Override
	public byte[] getImageUserMN(long id) throws Exception {
		// TODO Auto-generated method stub
		String image =mn.findById(id).get().getImage() ; 
	...
	public String generateUniqueUsername(String nom, String prenom) {
        ...
        if (!(mn.existsByUsername(baseUsername))) {
            ...
            while (mn.existsByUsername(uniqueUsernameBuilder.toString())) {
