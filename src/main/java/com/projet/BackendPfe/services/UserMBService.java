...
@Service
public class UserMBService implements IUserMB {
@Autowired UserMBRepository  mb;
	
	private List<UserMB> liste_mb=new ArrayList<UserMB>();
	@Override
	public byte[] getImageMB(long id) throws Exception {
		// TODO Auto-generated method stub
		String image =mb.findById(id).get().getImage() ; 
	...
	public String generateUniqueUsername(String nom, String prenom) {
        ...
        if (!(mb.existsByUsername(baseUsername))) {
            ...
            while (mb.existsByUsername(uniqueUsernameBuilder.toString())) {
